...
public class WaveMainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btTween.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                surfAnimation.stop();
                startActivity(new Intent(WaveMainActivity.this, Tween.class));
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_wave_main, menu);
        return true;
    }
